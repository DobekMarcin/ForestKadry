...
public class BookKeepingPatternAddPositionWindowController {
    ...
    public void addPositionButton() {
        ...
        try {
            ...
            if(bookKeepingPatternsPosition.getPatternId()==0 ||bookKeepingPatternsPosition.getPatternId()==null || bookKeepingPatternsPosition.getPositionId()<1 ||
            bookKeepingPatternsPosition.getName().isEmpty() || bookKeepingPatternsPosition.getAccountBlame().isEmpty() || bookKeepingPatternsPosition.getAccountHas().isEmpty() ||
                ...
                importDAO.addBookKeepingPatternPosition(bookKeepingPatternsPosition);
stage.close();
            }
